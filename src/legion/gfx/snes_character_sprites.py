...
class CharacterPalette:
    ...
    hair_shadow: tuple[int, int, int] = (46, 27, 24)
    hair_highlight: tuple[int, int, int] = (143, 82, 55)
    red: tuple[int, int, int] = (190, 56, 62)

    def to_pixel_palette(self) -> Palette:
        return {
            ".": TRANSPARENT,
            "O": rgba(self.outline),
            "D": rgba(self.hair_shadow),
            "H": rgba(self.hair),
            "L": rgba(self.hair_highlight),
            "S": rgba(self.skin),
...
CHARACTER_PALETTES: dict[str, CharacterPalette] = {
    "player": CharacterPalette(
        skin=(232, 155, 126),
        skin_shadow=(174, 92, 82),
        hair=(104, 54, 43),
        shirt=(55, 61, 64),
        shirt_shadow=(31, 35, 39),
        pants=(34, 37, 42),
        shoe=(24, 25, 30),
        hair_shadow=(54, 31, 31),
        hair_highlight=(160, 88, 63),
        red=(198, 54, 62),
    ),
